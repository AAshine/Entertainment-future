<template>
  <div class="ClassObject">
    <div class="classObject" v-for="(item,index) in ">
      <div class="classTitle">课程名称</div>
      <div class="classDoing">
        <div class="classDoingThree">
          ...
          <div class="classTeach">
            <i class="icon-renyuanguanli1"></i>讲师:某某某
          </div>
      ...
      <div class="classText">课程简介简介课程简介简介课程简介简介简介简介课程简介简介简介简介课程简介简介简介简介课程简介简介简介简介课程简介简介简介简介</div>
    </div>
  </div>
</template>
<script>
