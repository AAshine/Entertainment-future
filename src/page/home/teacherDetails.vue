      ...
      <div class="detailLeft">
        ...
        <div class="simpleMess">
          <div class="simpletime">
            时间：
            <span>{{teacherData.updateTime}}</span>
          </div>
          <div class="simpletime">
            来源：
            <span>{{teacherData.nikeName}}</span>
          </div>
          <div class="simpletime">
            作者：
            <span>{{teacherData.operator}}</span>
          </div>
          <div class="simpletime">
            点击：
            <span>{{teacherData.click}}</span>
          </div>
        </div>
        <div class="content">
          <div class="context" v-html="teacherData.context"></div>
